...
public class BevShopNoGUITest {
	...
	public static void main(String[] args) {
		...
		b.startNewOrder(12, Day.MONDAY, "John", 23); // My enum is named Day
		...
		if (b.validAge(tempAge)) {
			...
			b.processAlcoholOrder("Mohito", Size.SMALL); // My enum is named Size
		}
		...
		System.out.println("Add second alcohol drink"); // Add second alcohol
														// drink
		b.processAlcoholOrder("tonic", Size.LARGE); // My enum is named Size
		...
		System.out.println("Add third alcohol drink"); // Add third alcohol
														// drink
		b.processAlcoholOrder("wine", Size.SMALL); // My enum is named Size
		...
		b.processCoffeeOrder("cappuchino", Size.SMALL, true, true); // My eneum is named Size
		System.out.println(b.getNumOfAlcoholDrink()); // 3
		...
		b.startNewOrder(10, Day.SUNDAY, "Mary", 12); // My enum named Day

		System.out.println("Total on the Order:" + b.getCurrentOrder().calcOrderTotal()); // 0.0
		System.out.println("Add a SMOOTHIE to order"); // Add a SMOOTHIE to
														// order
		b.processSmoothieOrder("Morning Boost", Size.LARGE, 2, true); //My eneum is named Size
		System.out.println("Total on the Order:" + b.getCurrentOrder().calcOrderTotal()); // 6.5
		System.out.println("Add a COFFEE to order");
		b.processCoffeeOrder("Latte", Size.MEDIUM, false, false); //My eneum is named Size
		...
		if (b.validAge(b.getCurrentOrder().getCustomer().getAge())) {
			...
			b.processAlcoholOrder("mohito", Size.MEDIUM); //My eneum is named Size
		} else
		...
		b.processSmoothieOrder("Detox", Size.LARGE, numOfFruits, false); //My eneum is named Size
